...
export function RoomArt({ seats = [], height = 260 }: { seats?: ArtSeat[]; height?: number }) {
  return <div className="polymindStudio" style={{ minHeight: height }}>
    ...
    </div> : <div className="studioEmpty"><img src="/images/polymind-minds.png" alt="Personajes de Polymind" /><span>El espacio está listo.<br /><b>Conecta tu primer harness.</b></span></div>}
  </div>;
}
